...
const AdvancedMarketBG = ({ className = "" }) => (
    ...
    >
        ...
        <rect width="1200" height="800" fill="url(#techPatternSR)" />
        <path
        ...
        <path
            ...
            strokeWidth="2.5"
        />
        <rect width="1200" height="800" fill="url(#gridOverlaySR)" />
    </svg>
);
...
const deliverables = [
    {
        ...
        desc: "Research-backed Buy, Hold & Sell opinions",
        color: "#1A4B9B",
        icon: (
            <svg
                width="18"
    ...
    {
        title: "Comprehensive Stock Reports",
        desc: "Detailed company analysis with key financial insights",
        color: "#F36E21",
        icon: (
            <svg
                width="18"
    ...
    },
    {
        ...
        desc: "Target prices, support levels & downside evaluation",
        color: "#0D9488",
        icon: (
            <svg
                width="18"
    ...
    },
    {
        ...
        desc: "Industry trends and comparative performance insights",
        color: "#6366F1",
        icon: (
            <svg
                width="18"
    ...
    },
    {
        ...
        desc: "High-conviction stock ideas aligned with market conditions",
        color: "#D97706",
        icon: (
            <svg
                width="18"
...
export default function StockReports() {
    return (
        <main className="relative w-full bg-white font-sans overflow-x-hidden text-gray-800">
            <Helmet>
                <title>
                    Rightzone Research | Investment Strategy & Stock Research
                </title>
                <meta
                    name="description"
                    content="Access comprehensive investment reports from Rightzone Research featuring in-depth market analysis, stock research, sector insights, and investment recommendations to support informed investment decisions."
                />
            </Helmet>
            {/* ── HERO ── */}
            <section
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-7 flex flex-col justify-center">
                            <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-4 font-medium">
                                ...
                                comprehensive stock research and actionable
                                recommendations backed by in-depth market
                                analysis. Our reports combine fundamental
                                research, technical insights, and market trends
                                to identify high-potential investment
                                opportunities across a wide range of industries.
                            </p>
                            <p className="text-sm sm:text-base text-gray-500 leading-relaxed mb-12">
                                Each report is designed to provide clear
                                investment perspectives, helping you evaluate
                                opportunities, manage risk, and build a stronger
                            ...
                            <div className="border-t border-gray-200/60 pt-8 mt-4">
                                <div className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-6">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed font-medium flex-1 bg-gradient-to-r from-[#1A4B9B]/5 to-transparent p-4 rounded-xl border-l-2 border-[#1A4B9B]">
                                        Retail investors, portfolio managers,
                                        financial advisors, active traders, and
                                        market participants seeking reliable,
                                        research-driven stock recommendations
                            ...
                            <div className="relative w-full max-w-[460px]">
                                ...
                                >
                                    ...
                                    <div className="relative aspect-[4/5] rounded-[1.5rem] overflow-hidden bg-gradient-to-br from-[#eef2ff] to-[#fff7f3]">
                                        <img
                                            src="/assets/s4.jfif"
                                            alt="Investment Reports and Stock Recommendations"
